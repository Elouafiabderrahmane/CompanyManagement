...
public class SalaryServiceImpl implements SalaryService{
    ...
    public SalaryServiceImpl(final SalaryRepository salaryRepository,
    ...
    private SalaryDTO mapToDTO(final Salary salary, final SalaryDTO salaryDTO) {
        ...
        salaryDTO.setEmployers(salary.getEmployer() == null ? null : salary.getEmployer().getId());
